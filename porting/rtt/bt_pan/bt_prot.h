...
{
    rt_err_t (*prot_recv)(struct rt_bnep_device_t *bt_dev, void *buff, int len);
    struct rt_bnep_prot *(*dev_reg_callback)(struct rt_bnep_prot *prot, struct rt_bnep_device_t *bt_dev);
    void (*dev_unreg_callback)(struct rt_bnep_prot *prot, struct rt_bnep_device_t *bt_dev);
};
...
typedef void (*rt_bt_prot_event_handler)(struct rt_bnep_prot *port, struct rt_bnep_device_t *bt_dev, int event);

static void rt_bt_prot_event_handle(struct rt_bnep_device_t *bt_dev, rt_bt_dev_event_t event);
...
//rt_err_t rt_bt_prot_event_register(struct rt_bnep_prot *prot, rt_bnep_prot_event_t event, rt_bt_prot_event_handler handler);
